  ...
  describe("when run with arguments", () => {
    describe("valid input", () => {
      ...
      describe("full url + branch", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox https://github.com/truffle-conflux-box/bare-box#truffle-test-branch",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
      ...
      describe("full url + branch + relativePath", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox https://github.com/truffle-conflux-box/bare-box#truffle-test-branch:path/to/subDir --force",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
      ...
      describe("origin/master#branch", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox truffle-conflux-box/bare-box#truffle-test-branch",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
      ...
      describe("origin/master#branch:relativePath", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox truffle-conflux-box/bare-box#truffle-test-branch:path/to/subDir --force",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
      ...
      describe("git@ ssh + branch", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox git@github.com:truffle-conflux-box/bare-box#truffle-test-branch",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
      ...
      describe("git@ ssh + branch + relativePath", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            "unbox git@github.com:truffle-conflux-box/bare-box#truffle-test-branch:path/to/subDir --force",
            config,
            () => {
              const output = logger.contents();
              assert(output.includes("Unbox successful."));
