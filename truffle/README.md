...
This package is a distribution package of the Truffle command line tool. Please see [truffle-conflux-core](https://github.com/trufflesuite/truffle-conflux-core) to contribute to the main core code.
