...
If you run into an issue, the first step is to reach out in our [Gitter channel](https://gitter.im/ConsenSys/truffle-conflux),
in case others have run into the problem or know how to help.

To report a problem or to suggest a new feature, [open a GitHub Issue](https://github.com/truffle-confluxsuite/truffle-conflux/issues/new).
...
This repository ([truffle-confluxsuite/truffle-conflux](https://github.com/truffle-confluxsuite/truffle-conflux))
is a distribution package and only contains logic to build Truffle for release.

The main development repository is [truffle-confluxsuite/truffle-conflux-core](https://github.com/truffle-confluxsuite/truffle-conflux-core),
...
[`truffle-conflux-core`'s package.json](https://github.com/truffle-confluxsuite/truffle-conflux-core/blob/master/package.json)
...
First clone this repository and install NPM dependencies:
    ...
    $ git clone git@github.com:truffle-confluxsuite/truffle-conflux.git
    $ cd truffle-conflux
    $ npm install
...
(For instance, if you make a change to `truffle-conflux-migrate`, it will be used by
...
your fork(s) and submit a pull request upstream to `truffle-confluxsuite`'s fork(s).
...
command:
    ...
    $ meta pkgs checkout truffle-conflux:develop
...
(e.g. GitHub username **@ChocolateLover** modifying `truffle-conflux-artifactor`):

    $ cd dependencies/truffle-conflux-artifactor
    $ git remote add ChocolateLover git@github.com:ChocolateLover/truffle-conflux-artifactor.git
    $ git fetch --all
...
([readme](https://github.com/truffle-confluxsuite/meta-pkgs/blob/master/README.md)) to checkout en-masse:

    $ meta pkgs checkout truffle-conflux:develop truffle-conflux:ChocolateLover/sweet-feature --greedy
...
Join the chat in our [Gitter channel](https://gitter.im/ConsenSys/truffle-conflux). If anything about this
