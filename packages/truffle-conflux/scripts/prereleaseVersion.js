...
/**
 * This script checks out the specified branch, tags and publishes truffle-conflux at
...
if (!branch || !tag) {
  const help =
    ...
    `>>  truffle-conflux@4.1.12-next.0  truffle-conflux@next\n`;
...
const warn =
  ...
  "| Tag\n" +
  `  ------------------------------------------\n` +
  `  truffle-conflux@${version}`.padEnd(25) +
  `| truffle-conflux@${tag}\n\n`;
