...
const provision = require("truffle-conflux-provisioner");
const contract = require("truffle-conflux-contract");
const { Web3Shim } = require("truffle-conflux-interface-adapter");
const vm = require("vm");
...
class Console extends EventEmitter {
  ...
  start(callback) {
    ...
    try {
      this.web3.cfx.getAccounts().then(fetchedAccounts => {
