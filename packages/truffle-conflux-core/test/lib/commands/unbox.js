...
describe("commands/unbox.js", () => {
  const invalidBoxFormats = [
    "//",
    "/truffle-conflux-box/bare-box",
    "//truffle-conflux-box/bare-box#truffle-test-branch",
    "//truffle-conflux-box/bare-box#truffle-test-branch:path/SubDir",
    "/bare/",
    "//bare#truffle-test-branch",
    "//bare#truffle-test-branch:path/SubDir"
  ];
  const absolutePaths = [
    "https://github.com/truffle-conflux-box/bare-box:/path/SubDir",
    "truffle-conflux-box/bare-box:/path/subDir",
    "bare:/path/subDir",
    "git@github.com:truffle-conflux-box/bare-box:/path/subDir"
  ];
  const validBoxInput = [
    "https://github.com/truffle-conflux-box/bare-box",
    "truffle-conflux-box/bare-box",
    "bare",
    "git@github.com:truffle-conflux-box/bare-box",
    "https://github.com/truffle-conflux-box/bare-box#master"
  ];
  const relativePaths = [
    "https://github.com/truffle-conflux-box/bare-box:path/SubDir",
    "truffle-conflux-box/bare-box:path/subDir",
