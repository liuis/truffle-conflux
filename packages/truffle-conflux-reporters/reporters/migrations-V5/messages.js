  ...
  errors(kind, data) {
    ...
    const kinds = {
      ...
      intNoGas: () =>
        ...
        `      + Using the solc optimizer settings in 'truffle-conflux-config.js'\n` +
      ...
      blockNoGas: () =>
        ...
        `   * Try: setting gas manually in 'truffle-conflux-config.js' or as parameter to 'deployer.deploy'\n`,
