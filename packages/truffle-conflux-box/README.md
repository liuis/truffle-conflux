...
// `truffle-conflux-box` prompts when unboxing into non-empty directories & before potential overwrites
...
Truffle Boxes are configured via a required `truffle-conflux-box.json` file in the
