...
API Documentation for this library can be found at [trufflesuite.github.io/truffle-conflux-debugger](https://trufflesuite.github.io/truffle-conflux-debugger/).

## Library Usage

_:warning: This documentation is currently a work in progress.
Please see the [reference integration](https://github.com/trufflesuite/truffle/blob/develop/packages/truffle-conflux-core/lib/commands/debug.js) provided by the `truffle debug` command._
...
- `files` - An array of sourcePaths representing file indexes (from `solc` or `truffle-conflux-compile`)
...
```javascript
import Debugger from "truffle-conflux-debugger";
...
- [**`Session` class docs**](https://trufflesuite.github.io/truffle-conflux-debugger/class/lib/session/index.js~Session.html)
- **Docs for selectors:**
  - [**`ast` selectors**](https://trufflesuite.github.io/truffle-conflux-debugger/identifiers.html#ast-selectors)
  - [**`data` selectors**](https://trufflesuite.github.io/truffle-conflux-debugger/identifiers.html#data-selectors)
  - [**`evm` selectors**](https://trufflesuite.github.io/truffle-conflux-debugger/identifiers.html#evm-selectors)
  - [**`solidity` selectors**](https://trufflesuite.github.io/truffle-conflux-debugger/identifiers.html#solidity-selectors)
  - [**`trace` selectors**](https://trufflesuite.github.io/truffle-conflux-debugger/identifiers.html#trace-selectors)
