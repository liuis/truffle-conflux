...
const { shimContract } = require("truffle-conflux-compile/legacy/shims");
const {
...
const SUPPORTED_COMPILERS = {
  solc: {
    compiler: require("truffle-conflux-compile/new")
  },
  vyper: {
    compiler: require("truffle-conflux-compile-vyper"),
    legacy: true
  },
  external: {
    compiler: require("truffle-conflux-external-compile"),
    legacy: true
  }
};
