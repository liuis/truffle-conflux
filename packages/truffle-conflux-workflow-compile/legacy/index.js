...
const solcCompile = require("truffle-conflux-compile/legacy");
const vyperCompile = require("truffle-conflux-compile-vyper");
const externalCompile = require("truffle-conflux-external-compile");
